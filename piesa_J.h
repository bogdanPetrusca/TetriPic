...
void piesa_J()
{
	...
	int i,j;
	struct rgb **a;
	a = malloc(50 * sizeof(struct rgb *));
	for(i=0;i<50;i++)
		a[i] = malloc(40 * sizeof(struct rgb));
	...
	struct rgb **a_90;
	a_90 = malloc(40 * sizeof(struct rgb *));
	for(i=0;i<40;i++)
		a_90[i] = malloc(50 * sizeof(struct rgb));
	...
	for(i=0;i<header2->height;i++)
		for(j=0;j<header2->width;j++)
			a_90[ matrice_90[i][j].x ][ matrice_90[i][j].y + 49] = a[i][j];
	...
	piesa_rotita_90 = fopen("piesa_J_90.bmp","wb");
	...
	struct rgb **a_180;
	a_180 = malloc(50 * sizeof(struct rgb *));
	for(i=0;i<50;i++)
		a_180[i] = malloc(40 * sizeof(struct rgb));
	...
	piesa_rotita_180 = fopen("piesa_J_180.bmp","wb");
	...
	struct rgb **a_270;
	a_270 = malloc(40 * sizeof(struct rgb *));
	for(i=0;i<40;i++)
		a_270[i] = malloc(50 * sizeof(struct rgb));
	...
	for(i=0;i<header2->height;i++)
		for(j=0;j<header2->width;j++)
			a_270[ matrice_270[i][j].x + 39][ matrice_270[i][j].y] = a[i][j];
	...
	piesa_rotita_270 = fopen("piesa_J_270.bmp","wb");
